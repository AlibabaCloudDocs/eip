...
5.  在绑定弹性公网IP页面，完成以下配置，然后单击**确定**。 
    ...
    **说明：** 确保选择的辅助弹性网卡未绑定ECS实例。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/65386/156032333033380_zh-CN.png)

6.  绑定成功后，单击绑定的弹性网卡链接。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/65386/156032333033382_zh-CN.png)
...
8.  使用绑定的EIP登录ECS实例，查看该实例的网络配置。 
    ...
    **说明：** 确保ECS实例的安全组配置允许远程访问。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/65386/156032333133443_zh-CN.png)
